			...
			<div class="x_content">
			  ...
			  <form  class="form-horizontal form-label-left" method="post" autocomplete="off" action="<?php echo base_url('admin/profile'); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="password" autocomplete="off" id="password" name="password" value="<?php echo set_value('password'); ?>" placeholder="New Password" class="form-control col-md-7 col-xs-12 <?php if(form_error('password')){ echo "parsley-error"; } ?>">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="password" autocomplete="off" id="cpassword" name="cpassword" value="<?php echo set_value('cpassword'); ?>" placeholder="Confirm Password" class="form-control col-md-7 col-xs-12 <?php if(form_error('cpassword')){ echo "parsley-error"; } ?>">
