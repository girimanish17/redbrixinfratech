	  ...
	  <div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
		  <div class="x_panel">
			...
			<div class="x_content">
			  <br />
			  <form  class="form-horizontal form-label-left" method="post" autocomplete="off" action="<?= base_url() ?>admin/edit_job/<?php if($data) { echo $data->id;} ?>" enctype="multipart/form-data">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
						...
						<option value="">Select Job Type</option>
							<option <?php if($data->job_type == 1) { echo 'selected'; } ?> value="1">Fulltime</option>
							<option <?php if($data->job_type == 2) { echo 'selected'; } ?> value="1">Parttime</option>
					</select>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="time" autocomplete="off" id="shift_start_time" name="shift_start_time" value="<?php echo $data->shift_start_time; ?>" required placeholder="Add shift start time" class="form-control col-md-7 col-xs-12 <?php if(form_error('shift_start_time')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="time" autocomplete="off" id="shift_end_time" name="shift_end_time" value="<?php echo $data->shift_end_time; ?>" required placeholder="Add shift end time" class="form-control col-md-7 col-xs-12 <?php if(form_error('shift_end_time')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="number" autocomplete="off" id="position_count" name="position_count" value="<?php echo $data->position_count; ?>" required placeholder="Add position_count" class="form-control col-md-7 col-xs-12 <?php if(form_error('position_count')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="location" name="location" value="<?php echo $data->location; ?>" required placeholder="Add location" class="form-control col-md-7 col-xs-12 <?php if(form_error('location')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">				
					...
					<a href="<?php echo base_url() ?>admin/job_list" class="btn btn-danger">Back</a>
				  </div>
				</div>
