                  ...
                  <div class="x_content">
                    ...
                    <table id="" class="table table-striped	text-center" style="">
                      ...
                      <tbody>
						...
						$category = $this->common_model->getsingle('categories', array('id'=>$row->category));?>
							<tr>
							<td width="5%;"><?=$k+1?></td>
							...
							<td>
								...
								<a href="<?php echo base_url(); ?>admin/delete_list/<?php echo $row->id ?>/contact" onclick="return confirm('Do you want to delete this.');" class="btn btn-danger">Delete</a>
							</td>
							</tr>
                        <?php }} ?>
                      </tbody>
