<div class="">
	  ...
	  <div class="page-title">
		<div class="title_left">
		  <h3>Add Product Slider Image</h3>
		</div>
		  ...
		  <div class="x_panel">
			...
			<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<select id="project_id" name="project_id" class="form-control col-md-7 col-xs-12 <?php if(form_error('title')){ echo "parsley-error"; } ?>">
					<option value="" >Select Project </option>
					<?php if($projects){ ?>
					<?php foreach($projects as $p){ ?>
					<option value="<?php echo $p->id; ?>" <?php if(set_value('project_id')==$p->id){ echo "selected"; } ?> ><?php echo $p->project_title; ?></option>
					<?php } ?>
					<?php } ?>
					</select>
				...
				<div class="form-group">
				  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">				
					...
					<a href="<?php echo base_url() ?>admin/home_sliders" class="btn btn-danger">Back</a>
				  </div>
				</div>
