	  ...
	  <div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
		  <div class="x_panel">
			...
			<div class="x_content">
			  <br />
			  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url('admin/vehicles/'); ?>" >

				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Select Client <span class="required">*</span>
				  </label>
				  <div class="col-md-6 col-sm-6 col-xs-12">
					 <select disabled class="select2_single form-control <?php if(form_error('client_id')){ echo "parsley-error"; } ?>" name="client_id" tabindex="-1">
                            <option value="">Select Client </option>
							<?php if(count($clients)>0){ ?>
							<?php for($i=0;$i<count($clients);$i++){ ?>
							<option value="<?php echo $clients[$i]->client_id; ?>" <?php if($vehicles->client_id==$clients[$i]->client_id){ echo 'selected';} ?> ><?php echo $clients[$i]->client_name; ?></option>
							<?php } ?>					 
							<?php } ?>
                    </select>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input readonly type="text" autocomplete="off" id="vehicle_no" name="vehicle_no" value="<?php echo $vehicles->vehicle_no; ?>" class="form-control col-md-7 col-xs-12 <?php if(form_error('vehicle_no')){ echo "parsley-error"; } ?>">
