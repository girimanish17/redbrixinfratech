	  ...
	  <div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
		  <div class="x_panel">
			...
			<div class="x_content">
			  <br />
			  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url('admin/vehicle_edit/'.$vehicles->vehicle_id); ?>" >
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="vehicle_no" name="vehicle_no" value="<?php echo $vehicles->vehicle_no; ?>" class="form-control col-md-7 col-xs-12 <?php if(form_error('vehicle_no')){ echo "parsley-error"; } ?>">
