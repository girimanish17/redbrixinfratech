	  ...
	  <div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
		  <div class="x_panel">
			...
			<div class="x_content">
			  <br />
			  <form  class="form-horizontal form-label-left" method="post" action="<?php echo base_url('admin/material_edit/'.$materials->material_id); ?>" >

				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Material Name <span class="required">*</span>
				  </label>
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="material_name" name="material_name" value="<?php echo $materials->material_name; ?>" class="form-control col-md-7 col-xs-12 <?php if(form_error('material_name')){ echo "parsley-error"; } ?>">
